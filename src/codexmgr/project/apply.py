...
class ProjectBuild:
    ...
    Attributes:
        ...
        copy_files: Expected files inside managed skill copies.
...
def build_project_state(
    ...
    lock_data = _lock_data(config, locked_agents_md, skill_resolution, mcp_overrides)
    files = _generated_files(cwd, config, locked_agents_md, lock_data, codex_config)
    return ProjectBuild(
        files,
